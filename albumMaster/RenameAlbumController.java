...
public class RenameAlbumController extends AnchorPane {
	@FXML
	...
	RenameAlbumController(ListFileManager listFileController,ListView<String> interfaceAlbumList){
	...
	protected void renameAlbum() throws IOException{
	    ...
	    if(validName){
			...
			albumManager.renameAlbum(MainInterfaceController.selectedAlbum,newAlbumName);
	    	listFileController.renameAlbumToSystem(MainInterfaceController.selectedAlbum,newAlbumName);
	    	...
	    	System.out.println("[New Album Name Interface] [Button Album Name] Album Successfully Renamed.");
	    	stage.close();
	    }
	    else{
		    newNameField.clear();
		    System.out.println("[New Album Name Interface] [Button Album Name] Album Failed to be Renamed. Invalid FileName");	
	    }
	}
}
